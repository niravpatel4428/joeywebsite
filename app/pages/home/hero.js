...
const Hero = () => {
  ...
  return (
    <section className="relative md:h-[calc(100vh-198px)] pb-20 md:pb-10 xl:pb-14 max-md:pt-20">
      <div className="h-full w-full md:max-w-3xl lg:max-w-5xl xl:max-w-1296 px-4 md:px-10 mx-auto">
        <div className="h-full relative flex justify-center items-center">
          <div className="relative h-fit">
            <h1 className="text-foreground max-[350px]:text-[40px] text-5xl sm:text-7xl md:text-[95px] lg:text-[123px] xl:text-[160px] font-semibold leading-none tracking-[-4.54px] max-md:text-center">
              Private Cloud for <br /> AI Agents API
            </h1>
